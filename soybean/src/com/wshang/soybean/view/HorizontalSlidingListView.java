...
public class HorizontalSlidingListView extends ListView {
	...
	public HorizontalSlidingListView(Context context) {
		this(context, null);
	}

	public HorizontalSlidingListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public HorizontalSlidingListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			int judgePosition = isHaveHeader == true ? 1 : 0;
			
			if (motionPosition >= judgePosition) {
